...
nw4r::ut::FileStream* MusicSlotsExpand(nw4r::snd::DVDSoundArchive* archive, void* buffer, int size,
    ...
    if((firstChar == 'n' || firstChar == 'S' || firstChar == 'r') && !CupsConfig::IsReg(track) && (static_cast<RetroRewind::System::CTMusic>(Pulsar::Settings::Mgr::GetSettingValue(static_cast<Pulsar::Settings::Type>(RetroRewind::System::SETTINGSTYPE_RR2  ), RetroRewind::System::SETTINGRR2_RADIO_CTMUSIC)) == RetroRewind::System::CTMUSIC_ENABLED) == RetroRewind::System::CTMUSIC_ENABLED) {
